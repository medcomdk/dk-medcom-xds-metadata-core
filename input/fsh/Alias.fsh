...
//Alias: $TypeCode = http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-ihe-apd-typecode-VS
...
Alias: $EventCode = http://medcomfhir.dk/ig/xdsmetadata/ValueSet/MedCom-ihe-core-eventcodelist-VS
